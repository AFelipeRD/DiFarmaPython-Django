...
function editarPersonal(id, nombre, numpedido, fechapedido, contacto) {
  document.getElementById("id_personal_editar").value = id;
  document.getElementById("nombre_editar").value = nombre;
  document.getElementById("numpedido_editar").value = numpedido;
  document.getElementById("fechapedido_editar").value = fechapedido;
  document.getElementById("contacto_editar").value = contacto;
  
}

function editarProducto(id, codigo, nombre, nproveedor, precio, cantidad, laboratorio, presentacion, ml, mg, vencimiento) {
  document.getElementById("id_producto_editar").value = id;
  document.getElementById("codigo_editar").value = codigo;
  document.getElementById("nombre_editar").value = nombre;
  document.getElementById("nproveedor_editar").value = nproveedor;
  document.getElementById("precio_editar").value = precio;
  document.getElementById("cantidad_editar").value = cantidad;
  document.getElementById("laboratorio_editar").value = laboratorio;
  document.getElementById("presentacion_editar").value = presentacion;
  document.getElementById("ml_editar").value = ml;
  document.getElementById("mg_editar").value = mg;
  document.getElementById("vencimiento_editar").value = vencimiento;
  
}

function editarControlTemperatura(id, fechacontrol, horacontrol, humedad, temperatura) {
  document.getElementById("id_controltemperatura_editar").value = id;
  document.getElementById("fechacontrol_editar").value = fechacontrol;
  document.getElementById("horacontrol_editar").value = horacontrol;
  document.getElementById("humedad_editar").value = humedad;
  document.getElementById("temperatura_editar").value = temperatura;
...
function eliminarControlTemperatura(id) {
  document.getElementById("id_controltemperatura_eliminar").value = id;
}
